            ...
            <div class="">
                ...
                <div class="about-link">
                    <ul>
                        ...
                        <li><a href="<?php echo esc_url(admin_url( 'admin.php?page=st-settings&tab=language_settings')); ?>"><?php esc_attr_e('Step 2: Setup site languages', $this->plugin_name);?></a>&nbsp;<?php esc_attr_e('(You only need to do this once or whenever you wish to add new languages to your website)', $this->plugin_name);?></li>
