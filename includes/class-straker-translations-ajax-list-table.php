...
<?php
	...
	protected function pagination( $which ) {
		...
		if ( 'bottom' === $which ) {
			...
			$html_current_page = sprintf( "%s<input class='current-page st-trans-order-paged' id='current-page-selector' type='text' name='paged' value='%s' size='%d' aria-describedby='table-paging' /><span class='tablenav-paging-text'>",
	...
	protected function get_primary_column_name() {
		...
		if ( ! isset( $columns[ $default ] ) ) {
			$default = Straker_Translations_Ajax_List_Table::get_default_primary_column_name();
		}
...
?>
<table class="wp-list-table posts_pages <?php echo implode( ' ', $this->get_table_classes() ); ?>">
	<thead>
	<tr>
